...
# v2 去掉了 self attention 中 zero init alpha 的设计
# 重写了 uni_det_head_sep.py -> uni_det_head_seq_v2.py
...
# size_divisor = 28 if use_qwen_visual else 32
# img_scale = (1120, 560) if use_qwen_visual else (640, 640) # TODO:
# img_scale = (560, 280) if use_qwen_visual else (640, 640) # TODO:

det_query_num = 600 + (600 if use_stream else 0)
e2e_query_num = 1 + 18 # + 1 is for ego status
...
model = dict(
    ...
    save_path='./stage1_perception_pretrain_saved',  #save path for vlm models.
    use_grid_mask=False,
    frozen=False,
